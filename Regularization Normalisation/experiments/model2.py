    ...
    def __init__(self):
        ...
        self.convblock1 = nn.Sequential(
            nn.Conv2d(in_channels=1, out_channels=12, kernel_size=(
                3, 3), padding=0, bias=False),  # 28x28x1 --> 26x26x12 --> 3x3
            nn.ReLU(),
            nn.GroupNorm(num_channels=12, num_groups=3),
            nn.Conv2d(in_channels=12, out_channels=16, kernel_size=(
                3, 3), padding=0, bias=False),  # 26x26x12 --> 24x24x16 --> 5x5
            nn.ReLU(),
            nn.GroupNorm(num_channels=16, num_groups=4),
            nn.Conv2d(in_channels=16, out_channels=6, kernel_size=(
                1, 1), padding=1, bias=False),  # 24x24x16 --> 24x24x6 --> 5x5
            nn.ReLU(),
        ...
        self.convblock2 = nn.Sequential(
            nn.Conv2d(in_channels=6, out_channels=12, kernel_size=(
                3, 3), padding=0, bias=False),  # 12x12x6 --> 10x10x12 --> 12x12
            nn.ReLU(),
            nn.GroupNorm(num_channels=12, num_groups=3),
            nn.Conv2d(in_channels=12, out_channels=14, kernel_size=(
                3, 3), padding=0, bias=False),  # 10x10x12 --> 8x8x14 --> 16x16
            nn.ReLU(),
            nn.GroupNorm(num_channels=14, num_groups=2),
            nn.Conv2d(in_channels=14, out_channels=14, kernel_size=(
                3, 3), padding=0, bias=False),  # 8x8x14 --> 6x6x14 --> 20x20
            nn.ReLU(),
            nn.GroupNorm(num_channels=14, num_groups=2),
            nn.Conv2d(in_channels=14, out_channels=14, kernel_size=(
                3, 3), padding=1, bias=False),  # 6x6x14 --> 6x6x14 --> 24x24
            nn.ReLU(),
            nn.GroupNorm(num_channels=14, num_groups=2),
        )
...
class MNIST_BatchNorm(nn.Module):
    def __init__(self):
        ...
        self.convblock1 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.BatchNorm2d(12),
            nn.Conv2d(in_channels=12, out_channels=20,
                      kernel_size=(3, 3), padding=0, bias=False),
            nn.ReLU(),
            nn.BatchNorm2d(20),
            nn.Conv2d(in_channels=20, out_channels=6,
        ...
        self.convblock2 = nn.Sequential(
            nn.Conv2d(in_channels=6, out_channels=12, kernel_size=(
                3, 3), padding=0, bias=False),  # -> 10
            nn.ReLU(),
            nn.BatchNorm2d(12),
            nn.Conv2d(in_channels=12, out_channels=16, kernel_size=(
                3, 3), padding=0, bias=False),  # -> 8
            nn.ReLU(),
            nn.BatchNorm2d(16),
